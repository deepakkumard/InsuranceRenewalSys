    ...
    fun getdataFirebase() {
        ...
        databasereference.addChildEventListener(object : ChildEventListener {
            ...
            override fun onChildAdded(dataSnapshot: DataSnapshot, p1: String?) {
                ...
                if (days.equals("30")) {
                    var GST:Double=InsurancenumberModelclass.VCH_INSURED_AMOUNT.toDouble()+(5/100)
                    val uri = Uri.parse("smsto:"+InsurancenumberModelclass.MOB_NUM)
                    val intent = Intent(Intent.ACTION_SENDTO, uri)
                    intent.putExtra("sms_body", "Greetings from ADG INSURANCE COMPANY. This message is to notify you that about the end of the renewel period of your policy.  Please ensure that you would renew it before the last date of " + InsurancenumberModelclass.DTT_EXPIRY_DATE + " and your ref policy number : " + InsurancenumberModelclass.VCH_POLICY_NO +"your insurance renewal amount is : "+GST)
                    startActivity(intent)
                }
                ...
                if (days.equals("30")) {
                    ...
                    if (ActivityCompat.checkSelfPermission(
                        ...
                        intent.putExtra(
                            Intent.EXTRA_TEXT,
                            "Greetings from ADG INSURANCE COMPANY. This message is to notify you that about the end of the renewel period of your policy.  Please ensure that you would renew it before the last date of " + InsurancenumberModelclass.DTT_EXPIRY_DATE + " and your ref policy number : " + InsurancenumberModelclass.VCH_POLICY_NO+"your insurance renewal amount is : "+GST
                        )
